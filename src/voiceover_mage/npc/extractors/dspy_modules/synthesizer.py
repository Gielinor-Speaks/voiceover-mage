...
from .image_extractor import NPCVisualCharacteristics
from .text_extractor import NPCTextCharacteristics
...
class NPCDetails(BaseModel):
    ...
    personality_traits: str = Field(
        default="",
        description="Core personality traits from text analysis"
    )
    ...
    attire_style: str = Field(
        default="",
        description="Clothing and equipment styles"
    )
    ...
    color_palette: str = Field(
        default="",
        description="Dominant colors in appearance"
    )
...
class DetailSynthesisSignature(dspy.Signature):
    ...
    personality_synthesis: str = dspy.OutputField(
        description="Synthesized personality combining text and visual cues"
    )
    ...
    gap_filling: str = dspy.OutputField(
        description="What missing information was inferred and how"
    )
...
class DetailSynthesizer(dspy.Module):
    ...
    def forward(
        ...
        synthesis_result = self.synthesize(
            npc_name=npc_name,
            text_characteristics=text_json,
            visual_characteristics=visual_json
        )
