...
class TestSmartProgressTracker:
    ...
    def test_update_progress_basic(self):
        ...
        self.progress_mock.update.assert_called_once_with(self.task_id, description=status_message)
    ...
    def test_update_progress_with_npc_name(self):
        ...
        self.progress_mock.update.assert_called_once_with(self.task_id, description=expected_message)
